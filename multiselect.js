...
class MultiSelect {
    ...
    constructor(element, options = {}) {
        ...
        this.element.childNodes[1].multiselect = this;
    ...
    get height() {
        return this.options.height;
         ...
         populate_selects().then ((res) => {
            let definitions, tactics, theorems, extra;

            [definitions, tactics, theorems, extra] = (res);
            ...
            definition_select.placeholder   = "Select Definitions";
            theorem_select.placeholder      = "Select Theorems";
            tactic_select.placeholder       = "Select Tactic";
            extra_select.placeholder        = "Select Extra";
